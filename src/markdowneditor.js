...
module.exports = {
  ...
  enableSmartdown: function enableSmartdown () {
...
`
  ...
  unmarkdown: function unmarkdown (editor) {
    editor.toTextArea()
    editor.sourceElement.classList.remove('markdown-content')
    editor.element.parentElement.remove()
  },

  buildMarkdownEditors: function buildMarkdownEditors (editorMode) {
    ...
    const easyMDEConfig = {
      ...
      previewRender: function(plainText, preview) { // Async method
        if (!DO.U.MarkdownEditor.smartdownEnabled) {
          DO.U.MarkdownEditor.EasyMDE.prototype.options = DO.U.MarkdownEditor.EasyMDE.prototype.options || {};
...
`
    ...
    var easyMDEInstance = new DO.U.MarkdownEditor.EasyMDE(easyMDEConfig)
    ...
    window.markdowneditorVersion = '0.0.3'
  },
}
